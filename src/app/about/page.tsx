  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        ...
        <p className="text-gray-600 text-sm leading-relaxed mb-10">Based in the United States, we focus on fast domestic shipping, responsive customer support, and a curated catalog of commonly studied research compounds.</p>

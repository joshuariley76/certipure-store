    ...
    <footer className="bg-white border-t border-gray-200">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              ...
              <li><Link href="/shop" className="text-gray-500 hover:text-[#2d3ca5] text-sm transition">Blends</Link></li>
              <li><Link href="/shop" className="text-gray-500 hover:text-[#2d3ca5] text-sm transition">Coming Soon</Link></li>
            </ul>
          </div>
          <div>
            ...
            <ul className="space-y-2.5">
              ...
              <li><Link href="/testing" className="text-gray-500 hover:text-[#2d3ca5] text-sm transition">Lab Results & COAs</Link></li>
              <li><Link href="/contact" className="text-gray-500 hover:text-[#2d3ca5] text-sm transition">Contact Us</Link></li>
            </ul>
          </div>
          <div>
            ...
            <ul className="space-y-2.5">
              ...
              <li><Link href="/contact" className="text-gray-500 hover:text-[#2d3ca5] text-sm transition">Shipping & Returns</Link></li>
              <li><Link href="/contact" className="text-gray-500 hover:text-[#2d3ca5] text-sm transition">Privacy Policy</Link></li>
              <li><Link href="/contact" className="text-gray-500 hover:text-[#2d3ca5] text-sm transition">Terms of Service</Link></li>
            </ul>
          </div>
        </div>
      </div>
      <div className="border-t border-gray-100">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-5 flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <p className="text-gray-400 text-[11px] text-center sm:text-right max-w-md leading-relaxed">
            All products are intended strictly for laboratory and research purposes only. Not for human consumption. Must be 18+ to purchase.
          </p>
        </div>
      </div>
    </footer>
